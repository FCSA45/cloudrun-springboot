    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="powerBankRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="电量" prop="electricity">
          <el-input-number v-model="form.electricity" :min="0" :max="100" label="电量" />
        </el-form-item>
      </el-form>
      <template #footer>
...
import { listPowerBank, getPowerBank, delPowerBank, addPowerBank, updatePowerBank } from "../../../api/device/powerBank.js";
